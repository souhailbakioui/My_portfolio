...
<!-- Template Main CSS File -->
   ...
   <style>
        #hero {
            background: url('img/{{$data->homewallpaper}}');
        }
...
<body>
    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                <img src="img/{{$data->profilepic}}" alt="" class="img-fluid rounded-circle">
                <h1 class="text-light"><a href="#">{{$data->name}}</a></h1>
                <div class="social-links mt-3 text-center">
               @if ($data->twitter!="")  <a href="{{$data->twitter}}" class="twitter"><i class="bx bxl-twitter"></i></a>@endif
                @if ($data->facebook!="")  <a href="{{$data->facebook}}" class="facebook"><i class="bx bxl-facebook"></i></a>@endif
                 @if ($data->skype!="")   <a href="{{$data->skype}}" class="skype"><i class="bx bxl-skype"></i></a>@endif
                 @if ($data->linkedin!="")   <a href="{{$data->linkedin}}" class="linkedin"><i class="bx bxl-linkedin"></i></a>@endif
                 @if ($data->github!="")   <a href="{{$data->github}}" class="github"><i class="bx bxl-github"></i></a>@endif
                 @if ($data->instagram!="")   <a href="{{$data->instagram}}" class="instagram"><i class="bx bxl-instagram"></i></a>@endif
    </div>
</div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4" data-aos="fade-right">
                        <img src="img/{{$data->profilepic}}" class="img-fluid" alt="">
                    </div>
  ...
  @foreach($portfolio as $pr)
                  <div class="col-lg-4 col-md-6 portfolio-item">
                        <div class="portfolio-wrap">
                            <img src="img/{{$pr->projectpic}}" class="img-fluid" alt="">
